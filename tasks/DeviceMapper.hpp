...
#ifndef AUV_RAW_COMMAND_CONVERTER_DEVICEMAPPER_TASK_HPP
...
namespace auv_raw_command_converter {
     ...
     * The name of a TaskContext is primarily defined via:
     ...
     deployment 'deployment_name'
         task('custom_task_name','auv_raw_command_converter::DeviceMapper')
     end
     \endverbatim
     *  It can be dynamically adapted when the deployment is called with a prefix argument. 
     */
    class DeviceMapper : public DeviceMapperBase
    {
    ...
    public:
         ...
         */
        DeviceMapper(std::string const& name = "auv_raw_command_converter::DeviceMapper");
         ...
         * 
         */
        DeviceMapper(std::string const& name, RTT::ExecutionEngine* engine);
